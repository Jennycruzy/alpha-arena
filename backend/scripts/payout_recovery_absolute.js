...
async function run() {
    ...
    console.log(`\n🕵️‍♂️ ABSOLUTE RECOVERY SCAN FOR ${targetUser}`);

    const currentBlock = await provider.getBlockNumber();
    const lookback = 2000000; // 2M blocks is plenty
    ...
    console.log(`Scanning ${chunks.length} chunks with concurrency 50...`);
